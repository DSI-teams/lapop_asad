...
```{r}
argentina_factor <- factor_country("data/merged_argentina_2008_2014.dta")

belize_factor <- factor_country("data/merged_belize_2008_2014.dta")

bolivia_factor <- factor_country("data/merged_bolivia_2004_2014.dta")

brazil_factor <- factor_country("data/merged_brazil_2007_2014.dta") %>% 
...
chile_factor <- factor_country("data/merged_chile_2006_2014.dta")

colombia_factor <- factor_country("data/merged_colombia_2004_2014.dta")

costa_factor <- factor_country("data/merged_costa_rica_2004_2014.dta")

ecuador_factor <- factor_country("data/merged_ecuador_2004_2014.dta")

elsalvador_factor <- factor_country("data/merged_el_salvador_2004_2014.dta")

guatemala_factor <- factor_country("data/merged_guatemala_2004_2014.dta")

guyana_factor <- factor_country("data/merged_guyana_2006_2014.dta")

#haiti_factor <- factor_country("data/merged_haiti_2006_2014.zip")

honduras_factor <- factor_country("data/merged_honduras_2004_2014.dta")

# jamaica_factor <- factor_country("data/merged_jamaica_2006_2017.dta") %>% 
#   #Fixing inconsistency
#   rename(idnum_14_factor = idnum_1416_factor)

mexico_factor <- factor_country("data/merged_mexico_2004_2014.dta") %>% 
  #Correcting for inconsistencies in accents
  mutate(pais_factor = recode(pais_factor, México = "Mexico"))

nicaragua_factor <- factor_country("data/merged_nicaragua_2004_2014.dta")

panama_factor <- factor_country("data/merged_panama_2004_2014.dta") %>% 
  #Correcting for inconsistencies in accents
  mutate(pais_factor = recode(pais_factor, Panamá = "Panama"))

paraguay_factor <- factor_country("data/merged_paraguay_2006_2014.dta")

peru_factor <- factor_country("data/merged_peru_2006_2014.dta") %>% 
  #Correcting for inconsistencies in accents
  mutate(pais_factor = recode(pais_factor, Perú = "Peru"))

suriname_factor <- factor_country("data/merged_suriname_2010_2014.dta")
...
uruguay_factor <- factor_country("data/merged_uruguay_2007_2014.dta")

venezuela_factor <- factor_country("data/merged_venezuela_2007_2014.dta")
```

## Creating unfactored dataframes using `read_dta`
This is where we read in the unfactored data.
```{r}
argentina_unfactor <- read_dta("data/merged_argentina_2008_2014.dta")

belize_unfactor <- read_dta("data/merged_belize_2008_2014.dta")

bolivia_unfactor <- read_dta("data/merged_bolivia_2004_2014.dta")

brazil_unfactor <- read_dta("data/merged_brazil_2007_2014.dta")

# canada_unfactor <- read_dta("data/merged_canada_2006_2017.dta") %>% 
#   #Fixing inconsistency
#   rename(idnum_14 = idnum_1416)

chile_unfactor <- read_dta("data/merged_chile_2006_2014.dta")

colombia_unfactor <- read_dta("data/merged_colombia_2004_2014.dta")

costa_unfactor <- read_dta("data/merged_costa_rica_2004_2014.dta")

ecuador_unfactor <- read_dta("data/merged_ecuador_2004_2014.dta")

elsalvador_unfactor <- read_dta("data/merged_el_salvador_2004_2014.dta")

guatemala_unfactor <- read_dta("data/merged_guatemala_2004_2014.dta")

guyana_unfactor <- read_dta("data/merged_guyana_2006_2014.dta")

#haiti_unfactor <- read_dta("data/merged_haiti_2006_2014.zip")

honduras_unfactor <- read_dta("data/merged_honduras_2004_2014.dta")

# jamaica_unfactor <- read_dta("data/merged_jamaica_2006_2017.dta") %>% 
#   #Fixing inconsistency
#   rename(idnum_14 = idnum_1416)

mexico_unfactor <- read_dta("data/merged_mexico_2004_2014.dta")

nicaragua_unfactor <- read_dta("data/merged_nicaragua_2004_2014.dta")

panama_unfactor <- read_dta("data/merged_panama_2004_2014.dta")

paraguay_unfactor <- read_dta("data/merged_paraguay_2006_2014.dta")

peru_unfactor <- read_dta("data/merged_peru_2006_2014.dta")

suriname_unfactor <- read_dta("data/merged_suriname_2010_2014.dta")

# usa_unfactor <- read_dta("data/merged_united_states_2006_2017.dta") %>% 
#   #Fixing inconsistency
#   rename(idnum_14 = idnum_1416)

uruguay_unfactor <- read_dta("data/merged_uruguay_2007_2014.dta")

venezuela_unfactor <- read_dta("data/merged_venezuela_2007_2014.dta")
```
...
colombia_16_unfactor  <- read_dta("data/2016_colombia.dta") %>% 
  rename(person_id = uniq_id) %>% 
  assert(is_uniq, person_id) %>% 
  transform(person_id = as.character(person_id))
